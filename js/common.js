  ...
  document.body.insertAdjacentHTML('afterbegin', `
    ...
    <div class="topbar">
      ...
      <div class="topbar-actions">
        <span style="font-size:11px;color:var(--primary);background:var(--teal-bg);padding:3px 10px;border:1px solid rgba(13,200,200,.25);border-radius:20px;font-weight:700">gearlab.sujikumar.com</span>
